...
This project is a modernized and standalone desktop version of the original [Soroban](https://github.com/fjolliton/soroban) by @fjolliton. 
Changes made:
- Updated dependencies (Webpack 5, TypeScript 5, React 16+).
- Integrated Electron/Nativefier for desktop support.
